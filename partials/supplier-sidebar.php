...
<a class="sidebar-brand align-items-center justify-content-center" href="index.php">
	...
	<div class="sidebar-brand-text mx-3">Supplier Portal</div>
</a>
...
<li class="nav-item">
	<a class="nav-link" href="supplier-details.php">
		<i class="fas fa-fw fa-address-card"></i>
		<span>Supplier Details</span></a>
</li>
<li class="nav-item">
	<a class="nav-link" href="farm-manager-details.php">
		<i class="fas fa-fw fa-address-card"></i>
		<span>Farm Manager Details</span></a>
</li>
<li class="nav-item">
